...
##Pmod Header JE
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports opMode_btn]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports start_btn]
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports us_trig]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports us_echo]
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { encoder }]; #IO_L3N_T0_DQS_34 Sch=JE7
...
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports oLED_rst]

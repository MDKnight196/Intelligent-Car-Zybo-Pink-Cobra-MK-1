...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ForwardPWM [ create_bd_port -dir O ForwardPWM ]
  set LineScanClock [ create_bd_port -dir O LineScanClock ]
  set LineScanSI [ create_bd_port -dir O LineScanSI ]
  set ReversePWM [ create_bd_port -dir O ReversePWM ]
  set ServoPWM [ create_bd_port -dir O ServoPWM ]
...
CONFIG.NUM_PORTS {4} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M05_AXI [get_bd_intf_pins axi_gpio_2/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M06_AXI [get_bd_intf_pins axi_timer_2/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net axi_timer_0_pwm0 [get_bd_ports LineScanClock] [get_bd_pins axi_timer_0/pwm0]
  connect_bd_net -net axi_timer_1_interrupt [get_bd_pins axi_timer_1/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_timer_1_pwm0 [get_bd_ports LineScanSI] [get_bd_pins axi_timer_1/pwm0]
  connect_bd_net -net axi_timer_2_interrupt [get_bd_pins axi_timer_2/interrupt] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net btn_debounce_toggle_0_BTN_O [get_bd_pins btn_debounce_toggle_0/BTN_O] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net btn_debounce_toggle_1_BTN_O [get_bd_pins btn_debounce_toggle_1/BTN_O] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net dist_mem_gen_0_spo [get_bd_pins axi_gpio_2/gpio2_io_i] [get_bd_pins dist_mem_gen_0/spo]
  connect_bd_net -net encoder_1 [get_bd_ports encoder] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net opMode_btn_1 [get_bd_ports opMode_btn] [get_bd_pins btn_debounce_toggle_0/BTN_I]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_timer_1/s_axi_aclk] [get_bd_pins axi_timer_2/s_axi_aclk] [get_bd_pins btn_debounce_toggle_0/CLK] [get_bd_pins btn_debounce_toggle_1/CLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/M06_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins utrasonicDriver_0/iCLK] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net processing_system7_0_TTC0_WAVE0_OUT [get_bd_ports ReversePWM] [get_bd_pins processing_system7_0/TTC0_WAVE0_OUT]
  connect_bd_net -net processing_system7_0_TTC0_WAVE1_OUT [get_bd_ports ForwardPWM] [get_bd_pins processing_system7_0/TTC0_WAVE1_OUT]
  connect_bd_net -net processing_system7_0_TTC0_WAVE2_OUT [get_bd_ports ServoPWM] [get_bd_pins processing_system7_0/TTC0_WAVE2_OUT]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins axi_timer_2/s_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  ...
  connect_bd_net -net utrasonicDriver_0_pluseWidth [get_bd_pins utrasonicDriver_0/pluseWidth] [get_bd_pins xlconcat_1/In3]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x42820000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_timer_2/S_AXI/Reg] SEG_axi_timer_2_Reg
...
preplace inst utrasonicDriver_0 -pg 1 -lvl 4 -y 1380 -defaultsOSRD
preplace inst btn_debounce_toggle_0 -pg 1 -lvl 2 -y 1350 -defaultsOSRD

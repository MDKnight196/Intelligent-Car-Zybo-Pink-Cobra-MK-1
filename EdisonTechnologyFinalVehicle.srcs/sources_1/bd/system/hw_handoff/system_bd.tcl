...
# module references:
# btn_debounce_toggle, btn_debounce_toggle, utrasonicDriver
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set encoder [ create_bd_port -dir I encoder ]
  set oLED_rst [ create_bd_port -dir O -from 0 -to 0 oLED_rst ]
  set opMode_btn [ create_bd_port -dir I opMode_btn ]
  set start_btn [ create_bd_port -dir I start_btn ]
  set us_echo [ create_bd_port -dir I us_echo ]
  set us_trig [ create_bd_port -dir O us_trig ]
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  set_property -dict [ list \
CONFIG.coefficient_file {../../../../../../oLED.coe} \
CONFIG.data_width {8} \
CONFIG.depth {3456} \
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#I2C 0#I2C 0#UART 1#UART 1#UART 0#UART 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#SD 0#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0} \
CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#scl#sda#tx#rx#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
...
CONFIG.NUM_MI {6} \
  ...
  # Create instance: utrasonicDriver_0, and set properties
  set block_name utrasonicDriver
  set block_cell_name utrasonicDriver_0
  if { [catch {set utrasonicDriver_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $utrasonicDriver_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
...
CONFIG.NUM_PORTS {2} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_4_GPIO [get_bd_intf_ports leds_4bits] [get_bd_intf_pins axi_gpio_4/GPIO]
  ...
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports oLED_rst] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins dist_mem_gen_0/a]
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_0/interrupt] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net btn_debounce_toggle_0_BTN_O [get_bd_pins btn_debounce_toggle_0/BTN_O] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net btn_debounce_toggle_1_BTN_O [get_bd_pins btn_debounce_toggle_1/BTN_O] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net dist_mem_gen_0_spo [get_bd_pins axi_gpio_2/gpio2_io_i] [get_bd_pins dist_mem_gen_0/spo]
  connect_bd_net -net encoder_1 [get_bd_ports encoder] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net opMode_btn_1 [get_bd_ports opMode_btn] [get_bd_pins btn_debounce_toggle_0/BTN_I]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins btn_debounce_toggle_0/CLK] [get_bd_pins btn_debounce_toggle_1/CLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins utrasonicDriver_0/iCLK]
  ...
  connect_bd_net -net start_btn_1 [get_bd_ports start_btn] [get_bd_pins btn_debounce_toggle_1/BTN_I]
  connect_bd_net -net us_echo_1 [get_bd_ports us_echo] [get_bd_pins utrasonicDriver_0/echo]
  connect_bd_net -net utrasonicDriver_0_pluseWidth [get_bd_pins utrasonicDriver_0/pluseWidth] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net utrasonicDriver_0_trig [get_bd_ports us_trig] [get_bd_pins utrasonicDriver_0/trig]
...
#  -string -flagsOSRD
preplace port opMode_btn -pg 1 -y 720 -defaultsOSRD
preplace port DDR -pg 1 -y 440 -defaultsOSRD
preplace port encoder -pg 1 -y 920 -defaultsOSRD
preplace port us_echo -pg 1 -y 890 -defaultsOSRD
preplace port leds_4bits -pg 1 -y 320 -defaultsOSRD
preplace port us_trig -pg 1 -y 810 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 460 -defaultsOSRD
preplace port start_btn -pg 1 -y 820 -defaultsOSRD
preplace portBus oLED_rst -pg 1 -y 210 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 2 -y 290 -defaultsOSRD
preplace inst dist_mem_gen_0 -pg 1 -lvl 5 -y 60 -defaultsOSRD
preplace inst axi_timer_0 -pg 1 -lvl 4 -y 560 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 4 -y 910 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 4 -y 740 -defaultsOSRD
preplace inst utrasonicDriver_0 -pg 1 -lvl 5 -y 820 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 4 -y 200 -defaultsOSRD
preplace inst btn_debounce_toggle_0 -pg 1 -lvl 3 -y 730 -defaultsOSRD
preplace inst xlconcat_1 -pg 1 -lvl 1 -y 610 -defaultsOSRD
preplace inst btn_debounce_toggle_1 -pg 1 -lvl 3 -y 830 -defaultsOSRD
preplace inst axi_gpio_2 -pg 1 -lvl 4 -y 70 -defaultsOSRD
preplace inst axi_gpio_4 -pg 1 -lvl 4 -y 320 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 3 -y 210 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -y 530 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 2 4 NJ 440 NJ 440 NJ 440 NJ
preplace netloc opMode_btn_1 1 0 3 NJ 720 NJ 720 NJ
preplace netloc btn_debounce_toggle_0_BTN_O 1 3 1 960
...
preplace netloc utrasonicDriver_0_trig 1 5 1 NJ
preplace netloc processing_system7_0_axi_periph_M05_AXI 1 3 1 950
preplace netloc xlconcat_1_dout 1 1 1 220
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 2 220 390 600
preplace netloc axi_gpio_2_gpio_io_o 1 4 1 NJ
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 3 1 950
preplace netloc utrasonicDriver_0_pluseWidth 1 3 3 990 820 NJ 760 1490
preplace netloc axi_gpio_1_gpio_io_o 1 4 2 NJ 210 NJ
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 2 2 640 430 990
preplace netloc encoder_1 1 0 4 NJ 920 NJ 920 NJ 920 NJ
preplace netloc us_echo_1 1 0 5 NJ 890 NJ 890 NJ 890 NJ 830 NJ
preplace netloc xlconcat_0_dout 1 4 1 1250
preplace netloc dist_mem_gen_0_spo 1 4 2 NJ 110 1490
preplace netloc processing_system7_0_FIXED_IO 1 2 4 NJ 460 NJ 460 NJ 460 NJ
preplace netloc axi_gpio_0_ip2intc_irpt 1 0 5 20 670 NJ 670 NJ 670 NJ 670 1260
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 2 1 620
preplace netloc processing_system7_0_FCLK_CLK0 1 1 4 210 380 630 450 980 810 NJ
preplace netloc axi_gpio_4_GPIO 1 4 2 NJ 320 NJ
preplace netloc start_btn_1 1 0 3 NJ 820 NJ 820 NJ
preplace netloc btn_debounce_toggle_1_BTN_O 1 3 1 950
...
preplace netloc axi_timer_0_interrupt 1 0 5 30 680 NJ 680 NJ 660 NJ 660 1250
levelinfo -pg 1 0 120 410 800 1120 1380 1510 -top 0 -bot 1000
",
}
